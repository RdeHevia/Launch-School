...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: raulmac
--
...
ALTER TABLE public.weather OWNER TO raulmac;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: raulmac
--

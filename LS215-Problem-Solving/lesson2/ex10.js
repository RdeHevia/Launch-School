...
function matchWords (text, regex) {
  let matches = text.match(regex).map(word => word.toLowerCase());
  return matches;
}
...
function sentiment(text) {
  ...
  let positiveWordsInTheText = matchWords(text, positiveRegex);
  let negativeWordsInTheText = matchWords(text, negativeRegex);
